...
describe('window.hwcrypto', function(){
    ...
    describe('.auth()', function(){
        it('should be rejected with not implemented', function(){
            var cert = {};
            var hash = {
                type: 'SHA-1',
                hex: '30313233343536373839'
            };
            return window.hwcrypto.auth(cert, hash).should.be.rejectedWith(Error, window.hwcrypto.NO_IMPLEMENTATION);
        });
    });
}); 
